...
<head>
    ...
    <meta name="description"
        content="<?= isset($hotel->Hotel_Description) ? $hotel->Hotel_Description : lang('bookwithus'); ?>" />
    ...
    <meta property="og:image"
        content="<?= (isset($metaImg) ? $metaImg : base_url('public_designs/assets/icons/eomrah512.png')) ?>" />
    ...
    <link rel="apple-touch-icon" type="image/png"
        href="<?= base_url('public_designs/assets/icons/apple-touch-icon.png') ?>" />

    <link rel="alternate" type="text/html" hreflang="<?= $altlang ?>" href="<?= chLang2() ?>"
        title="<?= $altlangname ?>" />
    ...
    <header class="mh sticky-top">
        <div class="container pt-1 pb-1 px-0">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="<?= site_url("b2b/dashboard") ?>">
                    <?php if (lngdir() == "rtl") : ?>
                    <img src="<?= base_url('public_designs/assets/img/logo.png') ?>" class="img-fluid" width="160px"
                        height="50px" alt="">
                    <?php else : ?>
                    <img src="<?= base_url('public_designs/assets/img/logo.png') ?>" class="img-fluid" width="160px"
                        height="50px" alt="">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#mainMenu"
                    ...
                    <span class="navbar-toggler-icon text-center"><i class="fa fa-bars mcolor"></i><small
                            style="font-size: 60%;"><?= lang('menu') ?></small></span>
                </button>

                <div class="collapse navbar-collapse" id="mainMenu">
                    <ul class="navbar-nav mx-auto mt-3">
                        <li class="nav-item">
                            <a class="nav-link" href="<?= site_url("b2b/dashboard") ?>">
                        ...
                        <?php if ($this->session->userdata('b2bvalidated')) : ?>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="user_dropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php echo $this->session->userdata('C_FullName'); ?>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="user_dropdown">
                                <a href="<?= site_url("b2b/dashboard/profile") ?>"
                                    class="dropdown-item"><?= lang('prof') ?></a>
                                <div class="dropdown-divider"></div>
                                <a href="<?= site_url("b2b/hotel/invoice") ?>"
                                    class="dropdown-item"><?= lang('invoice_list') ?></a>
                                <div class="dropdown-divider"></div>
                                <a href="<?= site_url('b2b/login/logout') ?>"
                    ...
                    <div class="pt-3">
                        <ul class="navbar-nav">
                            ...
                            <div class="langs">
                                <li class="nav-item dropdown">
                                    <a class="nav-link" href="<?=site_url('b2b/hotel/invoice')?>" <span
                                        class="nav-link"><small><?=lang('remainingdeposit')?> :
                                        </small><?=$deposit?></span>
                                    </a>
                                </li>
                            </div>
