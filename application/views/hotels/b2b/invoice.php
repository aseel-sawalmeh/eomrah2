        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <div class="row mb-4 mt-3">
                    ...
                    <div class="col-sm-6">
                        <img src="<?php echo  base_url('public_designs/assets/img/logo.png'); ?>" class="img-fluid"
                            alt="Eomrah" width="300">
                    </div>
                    ...
                    <div class="col-sm-6 d-flex justify-content-end">
                        ...
                        <div class="text-center p-3">
                            ...
                            <img src="<?php echo  qrCode($idata->lat, $idata->lng); ?>" class="img-fluid" width="120"
                                alt="Eomrah">
                ...
                <div class="row justify-content-between mb-4">
                    ...
                    <div class="col-md-4 col-sm-12 pt-2 align-self-end">
                        ...
                        <span class="d-block"><strong class="font-weight-bold">Company Name</strong>:
                            <?= $idata->guest_name ?? $idata->Company_Name ?></span>
                        <span class="d-block"><strong class="font-weight-bold"><?= lang('phone_number') ?></strong>:
                            <?php echo $idata->C_PhoneNumber; ?></span>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-5 ml-auto text-center">
                        ...
                        <a class="btn pbtn p-3 font-weight-bold"
                            href="<?= site_url("b2b/hotel/payment/$idata->reservation_ref") ?>">
                            <?= lang('paynow') ?></a>
                        <?php endif; ?>

                        <?php if ($idata->Paid):?>
                        <a class="btn pbtn p-3 font-weight-bold"
                            href="<?=base_url("user/pdf/".$idata->reservation_ref)?>"
                            target="__blank"><?=lang("download_pdf")?></a>
                        <?php endif;?>
