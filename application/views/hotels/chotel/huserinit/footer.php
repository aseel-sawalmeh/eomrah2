...
<script src="<?=base_url()?>admin_design/custom/jquery.steps.min.js"> </script>
<script src="<?=base_url('admin_design/dist/js/adminlte.js')?>"></script>
<script src="<?=base_url('admin_design/plugins/daterangepicker/daterangepicker.js')?>"></script>


<script src="<?=base_url('admin_design/dist/js/demo.js')?>"></script>
<!-- <script src="http://maps.google.com/maps/api/js?key=<?=API_GOOGLE?>"></script> -->
<script src="<?= base_url('admin_design/custom/tools.js')?>"></script>
<script src="<?= base_url('admin_design/custom/gmap.js')?>"></script>
