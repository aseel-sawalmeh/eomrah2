                            ...
                            <div class="card-body">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div><?= lang("phone_number") ?><?php echo $idata->C_PhoneNumber; ?></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="text-center">
                                            <a class='btn-block btn-primary' href='<?php echo base_url('chotel/main/b2b_invoices'); ?>'>Go Back</a>
                                            <?php if ($idata->Payment_method == 1 && $idata->confirm == 0) : ?>
                                                <a class='btn-block btn-success' href='<?= site_url('chotel/main/b2b_paid/') . $idata->reservation_ref ?>'>Confirm Reservation</a>
                                          
                                                <?php elseif($idata->Payment_method == 2 && $idata->confirm == 0):?>
                                                <a  href='<?= site_url('chotel/main/b2b_confirm/') . $idata->reservation_ref ?>' class="btn-block btn-success">Confirm Reservation</a>
