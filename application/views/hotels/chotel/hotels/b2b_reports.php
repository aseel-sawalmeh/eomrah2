        ...
        <div class="card-header">
            <div class="card-tools">
                <div class="input-group input-group-md">
                    <input type="text" class="form-control float-right" placeholder="Search" id='livesearch' onkeyup="ShowB2bResult(this.value)" />
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <?php foreach ($providers as $prov) : ?>
                            <li class="list-item text-center"><a href="<?= base_url('chotel/main/b2b_invoices/') . $prov->Provider_ID ?>">
                    ...
                    <table class="table table-hover table-borderd text-nowrap">
                        ...
                        <tbody id="s_results">
                            <?php foreach ($reports as $rp) : ?>
                                <tr>
                                    <td><a href="<?= site_url('chotel/main/b2b_details/') . $rp->reservation_ref ?>"><?php echo $rp->reservation_ref; ?>
                                    </td>
