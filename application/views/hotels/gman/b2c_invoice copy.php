                            ...
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        ...
                                        <div>
                                            <strong><img
                                                    src="<?php echo  base_url('public_designs/assets/img/logo.png'); ?>"
                                                    class="img-fluid" alt="" width="150" height="100"></strong>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="text-center">
                                            <a class='btn-block btn-primary'
                                                href='<?php echo base_url('gman/main/b2c_reports'); ?>'>Go Back</a>
                                            <?php if ($expired) : ?>
