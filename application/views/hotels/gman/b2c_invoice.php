                ...
                <div class="card-body p-4">
                    ...
                    <div class="row justify-content-between mb-4">
                        ...
                        <div class="col-md-4 col-sm-12 pt-2 align-self-end">
                            ...
                            <span class="d-block"><strong class="font-weight-bold"><?= lang('guest_name') ?></strong>: <?= $idata->guest_name ?? $idata->Public_UserFullName ?></span>
                            <span class="d-block"><strong class="font-weight-bold"><?= lang('phone_number') ?></strong>: <?php echo $idata->Public_UserPhone; ?></span>
